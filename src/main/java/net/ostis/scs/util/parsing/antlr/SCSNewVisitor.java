...
public interface SCSNewVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SCSNewParser#sentence_internal_list}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSentence_internal_list(@NotNull SCSNewParser.Sentence_internal_listContext ctx);
	 ...
	 * @return the visitor result
	 */
	T visitSentence_assignment(@NotNull SCSNewParser.Sentence_assignmentContext ctx);
